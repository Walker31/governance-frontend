  ...
  const demoSections = [
    {
      ...
      action: "See how to register and classify AI systems",
      icon: BarChart3,
      color: "text-blue-600",
    },
    {
      ...
      action: "Watch real-time risk scoring in action",
      icon: Shield,
      color: "text-red-600",
    },
    {
      ...
      action: "Explore compliance dashboard features",
      icon: CheckCircle,
    ...
    },
    {
      ...
      action: "Learn policy creation and enforcement",
      icon: FileText,
    ...
    },
    {
      ...
      action: "Preview automated report generation",
      icon: TrendingUp,
    ...
    },
    {
      ...
      action: "Explore transparency features",
      icon: Users,
